    ...
    const emailPromises = donorsSnapshot.docs.map(async (doc) => {
        ...
        <body>
          <div class="wrapper">
            ...
            <div class="content">
              ...
              <div class="message">
                Please contact the coordinator/recipient family directly at the number listed above, or access your RaktSetu dashboard to coordinate assistance.
              </div>

              <div class="cta-container">
                <a href="https://raktsetu-portal.web.app/donor-dashboard" class="cta-button" target="_blank">Pledge Your Support Now</a>
              </div>
            </div>
            <div class="footer">
              <p style="margin: 0 0 5px 0;">&copy; ${new Date().getFullYear()} Team RaktSetu. All rights reserved.</p>
              <p style="margin: 0;">You are receiving this critical notification because you are a registered blood donor in the RaktSetu Emergency Network.</p>
            </div>
          </div>
        </body>
        </html>
      ...
      try {
        ...
        await resend.emails.send({
          from: 'RaktSetu Alerts <alerts@raktsetu.org>',
          to: [email],
          subject: subject,
          html: emailHtml
        });
