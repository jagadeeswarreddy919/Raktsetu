...
const AdminDashboard = () => {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", `raktsetu_platform_registry_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="p-8 bg-slate-900 text-white rounded-3xl shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative overflow-hidden border border-slate-800">
        ...
        <div>
          ...
          <h1 className="text-3xl font-black mt-2 tracking-tight">RaktSetu Command Center</h1>
                    ...
                    <div key={item._id} className="p-5 bg-white dark:bg-dark-900 border border-slate-200 dark:border-slate-800/50 rounded-2xl flex flex-col justify-between gap-4 shadow-sm hover:shadow-md transition-all">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        ...
                        {item.phone && (() => {
                          ...
                          return (
                            <a
                              href={`https://wa.me/${ph}?text=${encodeURIComponent(`Hi ${item.fullName}, contacting you from RaktSetu Admin regarding blood donation coordination.`)}`}
                              target="_blank"
