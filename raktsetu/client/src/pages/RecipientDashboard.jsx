...
const RecipientDashboard = () => {
  ...
  useEffect(() => {
    ...
    socket.on('request_accepted', (data) => {
      ...
      const waMessage = encodeURIComponent(`Hi ${data.donor.fullName}, I saw you accepted my blood request on RaktSetu. Can we coordinate the donation details?`);
                      ...
                      <div className="space-y-3 max-h-[280px] overflow-y-auto pr-2">
                        {selectedRequest.donorsPledged?.length > 0 ? (
                          selectedRequest.donorsPledged.map((p) => {
                            ...
                            const dWaMsg = encodeURIComponent(`Hi ${p.donor?.fullName || 'Donor'}, I am contacting you about my blood request on RaktSetu. Can we coordinate the donation?`);
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-100 dark:border-slate-800/80 mt-auto">
                        ...
                        {donor.phone && (() => {
                          ...
                          const waMsg = encodeURIComponent(`Hi ${donor.fullName}, I found your profile on RaktSetu and need ${filterBloodGroup} blood. Can you help?`);
                          return (
                            <a
