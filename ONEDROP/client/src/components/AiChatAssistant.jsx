...
const DEFAULT_WELCOME =
  'Hello! I am your ONEDROP AI assistant. Ask about blood donation eligibility, diet tips, emergency requests, or how to chat with matched donors.';
...
const getBotReply = (query) => {
  ...
  if (q.includes('badge') || q.includes('reward') || q.includes('point')) {
    return 'Earn ONEDROP points by pledging to requests and referring donors. Badges unlock as you level up on the donor dashboard.';
  }
